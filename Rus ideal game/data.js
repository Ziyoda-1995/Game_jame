...
const TITLES = [
    { badge: "📚", name: "Ученик обсерватории", desc: "Первый шаг в мир астрономии", level: 5 },
    { badge: "🔭", name: "Искатель звезд", desc: "Изучающий карту звездного неба", level: 10 },
    { badge: "⭐", name: "Звездочет", desc: "Знаток тайн звезд", level: 15 },
    { badge: "🌟", name: "Мастер созвездий", desc: "Специалист по зодиакальным созвездиям", level: 20 },
    { badge: "💫", name: "Небесный навигатор", desc: "Находящий путь по звездам", level: 25 },
    { badge: "🌌", name: "Ученый Зиджа", desc: "Изучивший Зидж Улугбека", level: 30 },
    { badge: "👑", name: "Мастер астрономии", desc: "Великий мастер астрономии", level: 35 },
    { badge: "🏆", name: "Султан астрономии", desc: "Наследник наследия Улугбека", level: 40 }
];

const TEST_QUESTIONS = [
    { q: "В каком городе Мирзо Улугбек построил обсерваторию?", options: ["Самарканд", "Ташкент", "Бухара", "Хива"], correct: 0 },
    { q: "Сколько звезд описано в каталоге Зидж Улугбека?", options: ["500", "994", "1018", "1200"], correct: 2 },
    { q: "Когда была построена обсерватория Улугбека?", options: ["1420", "1428", "1450", "1400"], correct: 1 },
    { q: "В каком созвездии находится Полярная звезда?", options: ["Большая Медведица", "Малая Медведица", "Кассиопея", "Дракон"], correct: 1 },
    { q: "В каком созвездии находится ярчайшая звезда Сириус?", options: ["Малый Пес", "Большой Пес", "Орел", "Лира"], correct: 1 },
    { q: "Как называется самая известная часть созвездия Орион?", options: ["Пояс", "Щит", "Меч", "Голова"], correct: 0 },
    { q: "Какое созвездие имеет форму буквы 'W'?", options: ["Пегас", "Кассиопея", "Цефей", "Андромеда"], correct: 1 },
    { q: "В каком созвездии находится звезда Вега?", options: ["Лира", "Лебедь", "Орел", "Дельфин"], correct: 0 },
    { q: "Сколько всего зодиакальных созвездий?", options: ["10", "11", "12", "13"], correct: 2 },
    { q: "Сколько лет Улугбек создавал свой Зидж?", options: ["10 лет", "20 лет", "30 лет", "40 лет"], correct: 2 }
];
